...
japanese = Category.create(name: "Japanese", description: "sushi n stuff", image: "images/japanese.png")
...
shogun = Restaurant.create(name: "Shogun", description: "the way of the tuna", image: "images/shogun.png", category: japanese)
sapparo = Restaurant.create(name: "Saparo", description: "the way of the salmon", image: "images/sapparo.png", category: japanese)

eltiempo = Restaurant.create(name: "El Tiempo", description: "pricey tacos", image: "images/eltiempo.png", category: mexican)
chipoltapec = Restaurant.create(name: "Chipoltapec", description: "hole in the wall tacos", image: "images/chipoltapec.png", category: mexican)

thaicottage = Restaurant.create(name: "Thai Cottage", description: "L4 equals Heaven", image: "images/thaicottage.png", category: thai)
spicythai = Restaurant.create(name: "Spicy Thai", description: "Is Hot!", image: "images/spicythai.png", category: thai)

dish1 = Dish.create(name: "2002 Roll", description: "Sooo Tasty", price: "12.99", image: "images/2002roll.png", restaurant: shogun)
dish2 = Dish.create(name: "Volcano Roll", description: "Volcano", price: "13.99", image: "images/volcanoroll.png", restaurant: shogun)
dish3 = Dish.create(name: "Philadelphia Roll", description: "Cream Cheese", price: "10.99", image: "images/philadelphiaroll.png", restaurant: shogun)
dish4 = Dish.create(name: "Dragon Roll", description: "The Mother Of", price: "25.99", image: "images/dragonroll.png", restaurant: shogun)
...
dish14 = Dish.create(name: "N1", description: "Noodles 1", price: "31.99", image: "images/n1noodles.png", restaurant: thaicottage)
dish15 = Dish.create(name: "N2", description: "Noodles 2", price: "34.99", image: "images/n2noodles.png", restaurant: thaicottage)
