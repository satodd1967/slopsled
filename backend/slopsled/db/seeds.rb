...
dish1 = Dish.create(name: "2002 Roll", description: "Sooo Tasty", price: "12.99", image: "no image", restaurant: shogun)
...
dish5 = Dish.create(name: "Hibachi Chicken", description: "Tastes Like Chicken", price: "31.99", image: "no image", restaurant: sapparo)
dish6 = Dish.create(name: "Hibachi Steak", description: "Moo Cow", price: "35.99", image: "no image", restaurant: sapparo)
dish7 = Dish.create(name: "Hibachi Shrimp", description: "They are little", price: "30.99", image: "no image", restaurant: sapparo)
...
dish8 = Dish.create(name: "Fish Fajitas", description: "Fishy Fishy", price: "36.99", image: "no image", restaurant: eltiempo)
